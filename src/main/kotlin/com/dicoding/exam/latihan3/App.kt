 ...
 *
 */
inline fun <reified T> checkType(args: T): String {

    val parameterType = when (T::class) {
        Int::class -> "Yes! it's Integer"
        String::class -> "Yes! it's String"
        Boolean::class -> "Yes! it's Boolean"
        Double::class -> "Yes! it's Double"
        kotlin.collections.List::class -> "Yes! it's List"
        Map::class -> "Yes! it's Map"
//        is Double -> "Yes! it's String"
        else -> "it's ${T::class}"
    }
